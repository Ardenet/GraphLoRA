...
if __name__ == '__main__':
    ...
    try:
        ...
        # Capture error message and check for "NVIDIA" in it
        error_msg = str(e)
        if "NVIDIA" in error_msg:
            print("NVIDIA GPU error detected. Switching to CPU.")
            args.gpu_id = -1  # Use this as a flag to indicate CPU usage
